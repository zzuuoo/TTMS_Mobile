...
//        cursor.close();
    ...
    private void postDataWithParame() {
        ...
        {
            Toast.makeText(getApplication(),"时间不不允许在过去",Toast.LENGTH_SHORT).show();
            return ;
        }
        ...
        switch (view.getId())
        {
            ...
            case R.id.sure_addschedule:
                if(p==null||s==null)
                {
                    ...
                    {
                        Toast.makeText(getApplication(),"数据不完整",Toast.LENGTH_SHORT).show();
                        break;
                    }
                    postDataWithParame();
//                    SimpleDateFormat format0 = new SimpleDateFormat("yy/MM/dd HH:mm");
...
//                    if (date.getTime()<new Date().getTime())
//                    {
//                        Toast.makeText(getApplication(),"时间不允许在过去",Toast.LENGTH_SHORT).show();
//                        break;
//                    }
//                    String sd1 = format1.format(date);
